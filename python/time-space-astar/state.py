# directly copied from the Space-Time-AStar repo
# https://github.com/GavinPHR/Space-Time-AStar/blob/master/stastar/state.py

# this will be the state of robots at a certain time (I think)
